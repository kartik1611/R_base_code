...
hepatitis_rf$importance # gives 1st column (accuracy will reduce if imp var are removed) 
...
# increase "ntree" and see if there is any improvement in the above metrics
