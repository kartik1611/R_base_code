...
setwd("G:/20161002_Batch18_CSE7219c_Lab02_SVD_SpecClust/text_docs")
...
LSA_space = lsa(Term_document_matrix, dims=2) ##considering only two singular values
...
q =query("analysts", rownames(Term_document_matrix))
Term_document_matrix
